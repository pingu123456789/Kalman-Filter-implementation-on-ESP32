...
void loop() {
  if (scd30.dataReady()) {
    ...
    float fused_humidity = w1 * sensor1_values[WINDOW_SIZE - 1] + w2 * sensor2_values[WINDOW_SIZE - 1] + w3 * sensor3_values[WINDOW_SIZE - 1] + w4 * sensor4_values[WINDOW_SIZE - 1];
